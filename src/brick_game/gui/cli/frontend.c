...
//         mvwprintw(stdscr, 4, 50, "stateofmachine: %d", tetris->stateofmachine);
//         mvwprintw(stdscr, 5, 50, "action: %d", tetris->action);
//         mvwprintw(stdscr, 7, 50, "pause: %d", tetris->gameinfo.pause);
//         mvwprintw(stdscr, 8, 50, "brick_coords_Y: ");
//         mvwprintw(stdscr, 9, 50, "brick_coords_X: ");
//         if (tetris->current_brick != 0) {
//             for (int i = 0; i < BRICK_SIZE; i += 2) {
//                 mvwprintw(stdscr, 8, 66 + i, "%d", tetris->current_brick[i]);
//                 mvwprintw(stdscr, 9, 66 + i, "%d", tetris->current_brick[i + 1]);
//             }   
//         }
//     }
// }